...
\author{Seth R.~Johnson$^{*}$ \and Jean-Luc Picard$^{\dagger}$}

\institute{
$^{*}$Department of Nuclear Engineering \& Radiological Sciences, University of Michigan, Ann Arbor, MI, 48109
\and
$^{\dagger}$Starfleet Headquarters, San Francisco, CA
}

\email{sethrj@umich.edu \and picard@example.com}
...
ligula sem et purus. Nulla interdum elit sed ligula aliquet nec interdum odio
imperdiet. Praesent condimentum justo eu diam gravida sed commodo eros iaculis.
Etiam adipiscing purus eget tortor scelerisque cursus. Donec vitae sem ante.
Integer massa justo, pellentesque eget facilisis id, sagittis vitae augue.
Etiam pulvinar aliquam tellus, faucibus imperdiet sapien hendrerit a.
