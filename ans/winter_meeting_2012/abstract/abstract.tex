...
%% \emph{Cyclus} is written in C++ and is composed of a core library
%% that is dynamically linked to a selection of module and utility
%% libraries. In its current form, \emph{Cyclus} uses XML-based
%% pre-processing and a SQL-based output database.
...
%% WE should have some results here, like the ones in your UNLV presentation.
